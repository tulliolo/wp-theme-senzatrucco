...
/**
 * Adds button class to reply links generated by comment_reply_link
 */
function senza_trucco_comment_reply_link_attributes($output){
    $str1 = "class='comment-reply-link";
	$str2 = " solid-button accent-button";
	return str_replace( $str1, $str1.$str2, $output);
}
add_filter('comment_reply_link', 'senza_trucco_comment_reply_link_attributes');
